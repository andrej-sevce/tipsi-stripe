...
RCT_EXPORT_METHOD(paymentRequestWithCardForm:(NSDictionary *)options
    ...
    NSString *nextStripeAccount = options[@"stripeAccount"] ? options[@"stripeAccount"] : stripeAccount;
